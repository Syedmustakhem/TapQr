...
import { QRCodeMaintenanceController } from "./qrcode-maintenance.controller";
...
const maintenanceController =
  new QRCodeMaintenanceController();
...
router.get(
  "/business/:businessId",
  controller.getBusinessQRCodes,
);

router.get(
  "/:id/branding",
  controller.getQRBranding,
);

router.put(
  "/:id/branding",
  validate(updateQRBrandingSchema),
  controller.updateQRBranding,
);

router.get(
  "/:id/maintenance",
  maintenanceController.checkQRCode,
);

router.get(
  "/:id",
  controller.getQRCodeById,
);
