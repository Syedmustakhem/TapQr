...
export const createQRCodeSchema = z
  ...
  .superRefine((data, ctx) => {
    ...
    if (
      ["CATALOG", "MENU", "SERVICES", "PRODUCTS"].includes(
        data.experienceType
      ) &&
      !data.catalogId
    ) {
...
export type UpdateQRBrandingInput = z.infer<
